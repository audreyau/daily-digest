...
function markdownToHTML(md) {
  return md
    ...
    .replace(/^(?!<[hublot]|<hr|<table|<thead|<tbody|<tr)(.+)$/gm, '<p>$1</p>')
    .replace(/<p><\/p>/g, '')
}
...
<body>
  ...
  <main>
    <h1>Daily Digest</h1>
    <p class="subtitle">An automated snapshot of my day — weather, top tech news, and a daily quote. Generated by a <a href="https://github.com/audreyau/daily-digest">GitHub Actions pipeline</a> every morning.</p>
